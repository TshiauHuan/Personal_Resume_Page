...
### 1.日期选择
问题：  
在编写日期选择的下拉框时，由于需要选择的年月日过多，直接列出所有的年月日或许不是一个聪明的选择，于是在编写时遇到困难。  

解决：  
通过网上搜索，发现别人使用JS代码实现。于是借鉴别人的代码后实现目标效果，如图所示：  
<img width="277" alt="Q1A1" src="https://github.com/user-attachments/assets/70754093-2dbd-4968-85fa-56174025d6bd">
...
```
### 2.城市选择
问题：在编写城市选择时，不知道如何通过选择对应省份，展示出相应的城市  

解决方法：通过网上寻找解决方案，以及询问GPT，发现可以使用JS代码来编写。最终实现效果如下：
<img width="214" alt="Q2A1" src="https://github.com/user-attachments/assets/acf7971d-bb53-4ecb-bb9e-56b12e229ca2">
...
// 城市选择
        ...
        document.querySelector('form').addEventListener('reset', function () {
            ...
            objcity.innerHTML = '<option value="请选择城市">请选择城市</option>';
        });
```
